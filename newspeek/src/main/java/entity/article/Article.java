...
public class Article {
     ...
     */
    public Article(String title, String text, String source) {
        this.title = title;
        this.text = text;
        this.source = source;
     ...
     */
    public Article(String title, String text, String source, int censoredWords, int replacedWords) {
        this.title = title;
        this.text = text;
        this.source = source;
     ...
     */
    public Article copy() {
        return new Article(this.title, this.text, this.source, this.censoredWords, this.replacedWords);
    }
